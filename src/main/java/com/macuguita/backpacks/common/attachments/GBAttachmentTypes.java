...
public class GBAttachmentTypes {
	...
	public static final AttachmentType<EquipmentAttachedData> EQUIPMENT_ATTACHMENT_TYPE = AttachmentRegistry.create(
			...
			builder -> builder
					.initializer(() -> EquipmentAttachedData.DEFAULT)
					.persistent(EquipmentAttachedData.CODEC)
					.copyOnDeath()
					.syncWith(EquipmentAttachedData.PACKET_CODEC, AttachmentSyncPredicate.all()));
